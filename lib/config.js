...
// A config that came out of validateConfig has already been read for stray
// keys. The CLI validates what it loads and then hands the result to
// ImageProcessor, which validates again — without this, one typo warns twice.
...
export function validateConfig(raw) {
  if (raw && typeof raw === 'object' && !checked.has(raw)) warnAboutUnknownKeys(raw)
